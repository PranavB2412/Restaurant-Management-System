...
//array of structures, containing name and price of all foods.
...
food order[100];
int order_pos = 0;     //Contains the number of items in the order
float subtotal = 0;    //To calculate the subtotal of all added items in menu

/* the function that takes in user's choice whether to order or not
*/
void customer()
{   
    char are_they_ordering;
    printf("---------------------Welcome to Cheesy Peasy :)---------------------\n\n");
    printf("Would you like to place an order? (Press Y to order, any other key to exit) ------>   ");
    ...
    //if number of items in the order is not zero, then the bill is calculated by invoking the calculate_bill() function
    if(order_pos!=0)
        calculate_bill();    

}

/* function to pick the cuisine
*/
void pick_cuisine()
{   
    char blank;     //the blank character input absords the newline character from the input stream
    scanf("%c",&blank);
    char cuisine_number;
    ...
    //We display the cuisine menu based on the choice of menu that they make here.
...
/* This function displays the food items in the French menu.
*/
void display_french_menu()
{
    printf("--------------------------------------------------------------\n");
...
/* This function displays the food items in the Italian menu.
*/
void display_italian_menu()
{
    printf("--------------------------------------------------------------\n");
...
/* This function displays the food items in the Chinese menu.
*/
void display_chinese_menu()
{   
    printf("--------------------------------------------------------------\n");
...
/* This function accepts food items ordered in the Indian menu and adds them to the sub total.
*/
void add_indian_order()
{
...
/* This function accepts food items ordered in the French menu and adds them to the sub total.
*/
...
/* This function accepts food items ordered in the Italian menu and adds them to the sub total.
*/
void add_italian_order()
{
    printf("What would you like to order? \n"); 
...
/* This function accepts food items ordered in the Chinese menu and adds them to the sub total.
*/
void add_chinese_order()
{
    printf("What would you like to order? \n"); 
...
/* This calculates the bill when invoked by the main() function.
    If the number of food items added to the order is zero, then this function is not invoked at all.
*/
void calculate_bill()
{
    float cgst = 0, sgst = 0;
