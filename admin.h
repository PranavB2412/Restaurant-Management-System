...
void admin(){
    ...
    */
	...
	switch(choice){
		...
		// infinite loop continues untile the break statement is entered
		while(1){
		system("cls"); //clear the console window
		printf("************************ Department *********************\n");
		printf("*                                                       *\n");
		...
		switch(choice){
			case '1':  
			system("cls");
			fseek(fd,0,SEEK_END); // search the file and move cursor to end of the file here 0 indicates moving 0 distance from the end of the file
	...
	switch(choice){
		...
		rewind(fp); //this moves file cursor to start of the file
		    printf("-----------------------------------------------------------------------------\n");
		    printf(" Id     | DepId | First Name     | Last Name    | Age           |Basic Salary\n");
		    printf("-----------------------------------------------------------------------------\n");
